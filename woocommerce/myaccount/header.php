...
<div class="my-account-header page-title normal-title
	...
	<?php echo ' text-' . get_theme_mod( 'my_account_title_align', 'left' ); ?>">
		...
		<div class="flex-col flex-grow" style="text-align:right;">
		<?php wc_get_template( 'myaccount/account-user.php' ); ?>
		
		<?php if ( is_user_logged_in() ) { ?>
			<a class="btn btn-logout" href="<?php echo esc_url( wc_get_endpoint_url( 'customer-logout', '', wc_get_page_permalink( 'myaccount' )) ); ?>"><?php _e('Logout','woocommerce'); ?></a>
		<?php } ?>
 </div>
	</div>
</div>
